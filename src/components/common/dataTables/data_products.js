    ...
    componentDidMount = () => {
        ...
        setTimeout(() => {
            if(this.props.roledetails.role[0]){
                if(this.props.roledetails.role[0].supprimerApproProduit == '1'){
                    this.setState({
                        deletable: true
                    })
                }
                if(this.props.roledetails.role[0].modifierApproProduit == '1'){
                    this.setState({
                    updatable: true
                    })
                }
                ...
                columns.push(
                    {
                        ...
                        Cell: (row) => (
                            ...
                            <div>
                                ...
                                <span>
                                    <Link to={`/supply/products/edit-product/${row.original.ID}`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Data_products)
