...
export class Data_maintains extends Component {
    ...
    componentDidMount = () => {
        ...
        setTimeout(() => {
            if(this.props.roledetails.role[0].supprimerMaintenance == '1'){
                this.setState({
                    deletable: true
                })
            }
            if(this.props.roledetails.role[0].modifierMaintenance == '1'){
                this.setState({
                   updatable: true
                })
            }
...
export default connect(mapStateToProps, mapDispatchToProps)(Data_maintains)
