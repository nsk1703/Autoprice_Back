...
export class Data_pieces extends Component {
    constructor(props) {
        super(props)
        // console.log(props)
        this.state = {
                ...
                columns.push(
                    {
                        ...
                        Cell: (row) => (
                            ...
                            <div>
                                ...
                                <span>
                                    <Link to={`/pieces/edit-piece/${row.original.ID}`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Data_pieces)