        ...
        columns.push(
            {
                ...
                Cell: (row) => (
                    <div>
                        ...
                        <span><Link to="/machines/create-machine"><i className="fa fa-pencil" style={{ width: 35, fontSize: 20, padding: 11,color:'rgb(40, 167, 69)' }}></i></Link></span>
                    </div>
